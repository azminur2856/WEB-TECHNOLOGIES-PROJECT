...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="../../asset/css/advisor/helpRequest.css">
    <script src="../../asset/js/advisor/helpRequestCheck.js"></script>
  </head>
  <body>
    ...
    <hr />
    <form action="../../controller/advisor_controller/helpRequestCheck.php" method="post" onsubmit="return validateHelpRequestForm()">
