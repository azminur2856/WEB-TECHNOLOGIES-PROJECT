...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../../asset/css/advisor/viewHelpRequest.css">
    <script src="../../asset/js/advisor/viewHelpRequest.js"></script>
</head>
<body>
...
<table align="right" id="viewHelpRequest" class="table-st" cellspacing="0" width="70%" border="1">
    ...
    <tr>
        <td colspan="5" align="center">
            <input type="text" id="search" name="search" placeholder="Search by Name/Email/Category" onkeyup="searchHelpRequest()">
        </td>
        <td>
