...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../../asset/css/admin/feedbackHelpRequest.css">
    <script src="../../asset/js/admin/feedbackCheck.js"></script>
</head>
<body>
    <h3 style="text-align: center">Feedback for Help Request</h3>
    <hr />
    <form action="../../controller/admin_controller/feedbackCheck.php" method="POST" onsubmit="return validateFeedbackForm()">
