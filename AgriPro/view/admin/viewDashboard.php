...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="../../asset/css/admin/viewDashboard.css">
  </head>
  <body>
      ...
      <table align="right" id="viewDashboard" class="table-st" cellspacing="0" width="70%">
        ...
        <tr>
          ...
          <td align="center">
            ...
            <img src="../../asset/image/admin/<?= htmlspecialchars($user['profile_picture']) ?>" alt="Profile Picture" style="width: 100px; height: auto;">
            <?php else: ?>
